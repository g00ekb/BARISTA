...
void ABARISTACharacter::NotifyControllerChanged()
{
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ABARISTACharacter::Look);
	}
	else
	{
...
void ABARISTACharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
